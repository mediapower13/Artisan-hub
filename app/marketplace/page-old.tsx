        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-7xl">
          <Tabs defaultValue="artisans" className="space-y-6 sm:space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
              <TabsList className="grid w-full max-w-md grid-cols-2 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-xl p-1 h-12 shadow-sm">
                <TabsTrigger 
                  value="artisans" 
                  className="rounded-lg data-[state=active]:bg-primary data-[state=active]:text-white transition-all duration-200 font-medium text-sm sm:text-base"
                >
